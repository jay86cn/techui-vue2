...
<div align="center">Digitcube數字魔方是一款簡單易用的可視化大屏前端框架，基於vue2開發</div>
...
<p align="center">
  ...
  <a href="https://www.youtube.com/watch?v=3A8ECsl5Q2g&t=6s&ab_channel=aYinCN">Youtube預覽</a> •
...
本開發包內的文件為開發源碼，僅需更新許可證即可用於商業項目開發，詳情請聯繫管理員。



- 免費用戶，可以通過本開發包學習數據可視化的開發思路、設計、主題、多語言、樣式、佈局、以及echarts的使用等
- 授權用戶，聯繫管理員更新許可證後直接進入開發階段。
...
**移動端數據屏的開發源碼，位於telgram群組中，群組鏈接在文檔下方，請自取。**
...
**以下數據屏以及更多demo，請查閱 [數字魔方演示站](http://124.222.103.91/)** 
...
- **🚀穩步迭代急速響應**
  ...
  本框架歷經兩個大版本，無數小版本的迭代，bug修復及時，功能拓展穩步進行中。對於付費用戶可以做到及時響應。
