...
<div class="echarts-hasSelect">
  <el-select v-if="false" v-model="select.current" size="mini" style="width:100px" filterable placeholder="选择井场">
    <el-option
  ...
  methods: {
    processData(){
      ...
      xAxis.forEach((item,i)=>{
        xAxis[i]=this.$t(`dashboardE.b3.xAxi`)+(i+1)
      })
