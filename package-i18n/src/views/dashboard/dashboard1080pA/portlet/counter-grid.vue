<template>
  <div class="dashboardAG-counterGrid">
...
export default {
  ...
  mounted() {
    this.arry.forEach((item,i)=>{
      item.title=this.$t("dashboardA.r1.counter"+i);
      item.unit=this.$t("dashboardA.r1.unit");
    })
  }
};
</script>
<style lang="less">
.dashboardAG-counterGrid{.grid(2,2,12px); height: 100%; position: relative;
