<template>
    <dv-scroll-board v-if="!option.reset" :config="option" class="dashboardAG-scrollBoard-table"  />
</template>
<script>
export default {
  name: "blockCenter",
...
<style lang="less">
.dashboardAG-scrollBoard-table{.poa; left:10px; right:10px; top:40px; bottom:10px; width:auto;height:auto; 
  .header{
    .header-item{.ff("cn1"); }
  }
  .rows{
