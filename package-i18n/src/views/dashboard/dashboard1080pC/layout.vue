            ...
            <component :is='item.border' :config="getConfig(item)">
              ...
              <template v-else>
                <template v-for="chart in item.charts" v-if="chart.activeIn==tabActive">
                  ...
                  <panelTitleA1 :config="panelTitleConfig" >{{$t(`dashboardC.PTitle.${chart.id}`)}}</panelTitleA1>
      ...
      areas:[
        ...
        {name:"right",portlets:[
          ...
          {border:"aYinTechBorderB4",charts:[
            ...
            {id:"r2_3",title:"Water level B",component:"echartsLineC",activeIn:2}
          ]},
          {border:"aYinTechBorderB4",charts:[
            ...
            {id:"r3_3",title:"Buried depth B",component:"echartsBarA",activeIn:2}
          ]},
          {border:"aYinTechBorderB4",charts:[
            ...
            {id:"r4_2",title:"Water consumption B",component:"rankingBoard",activeIn:2}
          ]},
        ]},
