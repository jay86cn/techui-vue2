    ...
    <div class="counter-item" v-for="(item,index) in counterList">
      <div class="name">
        <div class="name-inner">
          <span class="desc1">{{$t(`dashboardD.c1.item${index+1}`)}}</span>
          <span class="desc2">{{$t(`dashboardD.c1.detp`)}}</span>
        </div>
      </div>
      <div class="content">
        <div class="counter-val" v-for="(val,i)  in item.val">
          ...
          <span class="label">{{i==0?$t(`dashboardD.c1.type1`):$t(`dashboardD.c1.type2`)}}</span>
        </div>
      </div>
