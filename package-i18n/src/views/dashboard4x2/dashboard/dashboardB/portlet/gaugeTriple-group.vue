...
export default {
  name: "blockCenter",
  components: {
    echartsGaugeLeft:() => import('./guageGroup/echarts-gaugeBLeft.vue'),
    echartsGaugeCenter:() => import('./guageGroup/echarts-gaugeA.vue'),
    echartsGaugeRight:() => import('./guageGroup/echarts-gaugeBRight.vue'),
  },
  data(){return{
