<template>
  <div class="screenSingleC" id="screenC" :style="svgBG1">
...
export default {
  ...
  components: {
    ...
    echartsPictorialBar:() => import('./portlet/echarts-pictorialBar'),
    scrollBoard:() => import('./portlet/scrollBoard'),
    echartsPieA:() => import('./portlet/echarts-pieA'),
  },
  data() {
    return {
...
<style lang="less">
.screenSingleC {.poa; .fullbox; z-index: 1; padding:90px 30px 90px 30px;//pointer-events: none;
