<template>
<div class="chart-hasTabs-SA theme">
  ...
  <div class="total-digital">
    ...
    <DigitalTransform  class="counter" :value="total" :interval="$vuex.state.globalConfig.ani?1000:0" :dislocation="false" ></DigitalTransform>
  </div>
...
.chart-hasTabs-SA{height: 100%;
  ...
  .unit{.poa; right:10px;top:5px;.fc(var(--font-weak)); opacity: .5;}
}
