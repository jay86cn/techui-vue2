...
export default {
  ...
  methods: {
    ...
    initData(){
      this.chartData.data=[
        {
          name: this.$t("portlet.r3.group1.title"),
          children: [
            {
              name: this.$t("portlet.r3.group1.sub1.title"),value:123,
              children: [
                { name: this.$t("portlet.r3.group1.sub1.item1"), value: 49 },
                { name: this.$t("portlet.r3.group1.sub1.item2"), value: 25},
                { name: this.$t("portlet.r3.group1.sub1.item3"), value: 11 }
              ]
            },
            {
              name: this.$t("portlet.r3.group1.sub2.title"),value:90,
              children: [ 
                { name: this.$t("portlet.r3.group1.sub2.item1"), value: 35 }, 
                { name: this.$t("portlet.r3.group1.sub2.item2"), value:15 } 
              ]
            }
          ]
        },
        {
          name: this.$t("portlet.r3.group2.title"), children: [
            {
              name: this.$t("portlet.r3.group2.sub1.title"),value:230, children: [ 
                { name: this.$t("portlet.r3.group2.sub1.item1"), value: 43 }, 
                { name: this.$t("portlet.r3.group2.sub1.item2"), value: 121 } 
              ]
            },
            {
              name: this.$t("portlet.r3.group2.sub2.title"),value:55, children: [ 
                { name: this.$t("portlet.r3.group2.sub2.item1"), value: 23 }, 
                { name: this.$t("portlet.r3.group2.sub2.item2"), value: 12 } 
              ]
            }
          ]
        }
    ...
    processOption(){
      ...
      this.chartOption={
        update:false,
        title:{ 
          text:this.$t("portlet.r3.tip"),subtext:"", x:20, bottom:0, 
