...
.map-counter-mobile-wrap{.poa; left:15px; right:15px; top:80px; z-index: 10; display: grid; grid-template-columns: repeat(2,1fr); grid-template-rows:repeat(2,1fr); grid-gap: 20px;
