...
export default {
  ...
  data() {
    return {
      ...
      portlets:[
        {title:"銷售業績統計表",component:"echartsPieA",border:"DVBorderBox2"},
        {title:"各城區人力資源表",component:"echartsPictorialBar",border:"DVBorderBox2"},
        {title:"銷售業績統計表",component:"echartsLineC",border:"DVBorderBox1",hideTitle:true},
        {title:"滾動列表",component:"scrollBoard",border:"DVBorderBox2"},
      ]
    };
  },
  computed: {},
