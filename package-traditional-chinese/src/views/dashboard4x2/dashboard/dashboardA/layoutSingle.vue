...
export default {
  ...
  data() {
    return {
      ...
      showMap:false,
      portlets:[
        {title:"重點指標",component:"counter",border:"aYinTechBorderB1",hideTitle:true},
        {title:"非煤礦山情況",component:"echartsPieA",border:"aYinTechBorderB4"},
        {title:"井下人員情況",component:"personalCondition",border:"aYinTechBorderB4"},
        {title:"本月事故情況",component:"echartsLineA",border:"aYinTechBorderB4"},
        {title:"煤礦生產標準化",component:"pyramid",border:"aYinTechBorderB4"},
        {title:"聯網接入情況",component:"echartsBarSpc",border:"aYinTechBorderB4"},
        {title:"執法情況",component:"echartsBarLineTabs",border:"aYinTechBorderB4",hideTitle:true},
      ]
    };
  },
  computed: {
