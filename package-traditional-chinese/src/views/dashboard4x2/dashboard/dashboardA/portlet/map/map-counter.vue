...
.dashboard4X2A-map{
  .map-counter-wrap{.poa; left:50%; .fixc("x"); top:100px; z-index: 10;
    .counter-item{.bd(var(--button-bd_hov)); .bgc(var(--popup-bg)); width: 170px; display:inline-block; height: 60px; margin:0 20px 0 0; padding:10px 0 0 60px; position: relative;
