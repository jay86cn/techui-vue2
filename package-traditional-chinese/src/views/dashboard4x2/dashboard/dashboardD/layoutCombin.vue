...
export default {
  ...
  data() {
    return {
      ...
      portlets:[
        {title:"實時流速圖",component:"echartsBarHoriA",border:"DVBorderBox2",color:[0,1,3]},
        {title:"根源告警分佈",component:"echartsHitmapGroup",border:"DVBorderBox1",color:[0,2,3],hideTitle:true},
        {title:"告警情況",component:"echartsGaugeCounter",border:"DVBorderBox2",color:[0,1,3]},
        {title:"多組儀表範例",component:"echartsGaugeFour",border:"DVBorderBox2",color:[0,1,3]},
