...
export default {
  ...
  data() {
    return {
      ...
      portlets:[
        {title:"異常特徵分佈",component:"echartsRadar",border:"DVBorderBox2"},
        {title:"重點監控告警",component:"echartsGaugeTriple",border:"DVBorderBox1",hideTitle:true},//,class:"noAni"
        {title:"散點分佈圖",component:"echartScatter",border:"DVBorderBox2"},
