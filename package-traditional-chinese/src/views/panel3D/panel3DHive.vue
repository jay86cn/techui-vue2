...
<template>
   <adaptivePanel :config="adptivePanelConfig">
    <div class="view3d-state" :class="[globalConfig.panel3D?'on3D':'off3D']">
      <div class="state state-on">3D視圖已打開</div>
      <div class="state state-off">3D視圖已關閉</div>
      <div class="desc">請在全局配置項中打開3D面板功能</div>
    </div>
    <div class="title-desc">Hive模式，所有的面板變形方向朝向光標，所有的參數公用，通過v-for循環</div>
