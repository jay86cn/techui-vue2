<template>
  <div class="counterGrid6-ScreenE">
...
export default {
  ...
  data() {
    return {
      arry:[
        {title:"年度合同總額",icon:"i carbon:thumbnail-1",unit:"萬元",total:"14276"},
        {title:"年度回款總額",icon:"i carbon:table-built",unit:"萬元",total:"14276"},
        {title:"年度開票金額",icon:"i carbon:thumbnail-preview",unit:"萬元",total:"3135"},
        {title:"年度淨利潤",icon:"i carbon:analytics",unit:"萬元",total:"769"},
        {title:"年度合同總數",icon:"i carbon:document-attachment",unit:"份",total:"3135"},
        {title:"銷售統計",icon:"i carbon:chart-histogram",unit:"人",total:"769"},
      ],
      borderConfig: {
        decoration: false,
        opacity: 0.7
...
<style lang="less">
.counterGrid6-ScreenE{.grid(2,3,20px); height: 100%;  position: relative;
