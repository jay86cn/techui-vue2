<template>
    <div class="ScreenB-rankingBoard-wrapper">
...
export default {
  ...
  data() {
    return {
        chartData:{
          legend:['企業A長企業名稱長企業名稱AA','企業B','企業C','企業D','企業E','企業F','企業G'],
...
<style lang="less">
.ScreenB-rankingBoard-wrapper { height: 100%; padding:40px 20px 20px 20px; position: relative;
