...
export default {
  ...
  data() {
    return {
      ...
      areas:[
        {name:"left",portlets:[
          {id:"r1",title:"銷售情況",component:"chartCounter",border:"blank"},
          {id:"r2",title:"任務完成情況",component:"echartsGaugeTriple",border:"blank"},
          {id:"r3",title:"開支佔比",component:"echartsRadar",border:"blank"},
        ]},
        {name:"right",portlets:[
          {id:"l2",title:"收支情況",component:"echartsPieTabs",border:"blank"},
          {id:"l3",title:"業務收益情況",component:"echartsBarHorizA",border:"blank"},
          {id:"l1",title:"行業收入佔比",component:"echarts-hill",border:"blank"},
        ]},
