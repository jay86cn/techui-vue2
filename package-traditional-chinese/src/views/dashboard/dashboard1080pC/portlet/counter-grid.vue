  ...
  data() {
    return {
      arry:[
        ...
        {title:"國控自動站",icon:"i carbon:building",unit:"",total:"4276"},
        {title:"國土自動站",icon:"i carbon:building-insights-1",unit:"",total:"1873"},
        {title:"省級自動站",icon:"i carbon:building-insights-2",unit:"個",total:"3135"},
        {title:"人工監測站",icon:"i carbon:building-insights-3",unit:"個",total:"769"},
      ],
      borderConfig: {
        decoration: false,
        opacity: 0.7
...
<style lang="less">
.counterGrid{.grid(2,2,15px); height: 100%; position: relative;
  .aYinTechBorderB2{ padding:0;   position: relative; 
    ...
    .inner-content{
      ...
      .total{margin: 0; text-align: left; line-height: 30px; .poa; left:20px; right:0; top:57%; .fixc("y");
