...
export default {
  ...
  data() {
    return {
      counterList:[
        {name:"靖邊",val:[63,478],unit:"個"},
        {name:"隴東",val:[231,828],unit:"個"},
        {name:"靖安",val:[82,472],unit:"個"},
        {name:"姬塬",val:[147,827],unit:"個"},
        {name:"對外合作",val:[125,73],unit:"個"},
        {name:"烏審旗",val:[842,24],unit:"個"},
