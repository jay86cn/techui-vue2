  ...
  data() {
    return {
      arry:[
        ...
        {title:"人工成本",icon:"i carbon:events-alt",unit:"萬元",total:"14276"},
        {title:"直接材料費",icon:"i carbon:cloud-satellite",unit:"萬元",total:"14276"},
        {title:"折舊及攤銷費",icon:"i carbon:network-admin-control",unit:"萬元",total:"3135"},
        {title:"內部結算",icon:"i carbon:delivery-parcel",unit:"萬元",total:"769"},
        {title:"間接費用分攤",icon:"i carbon:concept",unit:"萬元",total:"3135"},
        {title:"其他直接支出",icon:"i carbon:cics-system-group",unit:"萬元",total:"769"},
      ],
      borderConfig: {
        decoration: false,
        opacity: 0.7
...
<style lang="less">
.counterGrid6-1080D{.grid(2,3,12px);height: 100%; position: relative;
