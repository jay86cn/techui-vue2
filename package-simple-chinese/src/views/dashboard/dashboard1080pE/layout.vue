...
export default {
  ...
  data() {
    return {
      ...
      portlets:[
        {title:"统计模块",component:"counterGrid",border:"blank",hideTitle:true},
        {title:"重点信息看板",component:"echartsBarLine1",border:"DVBorderBox1",hideTitle:true},
        {title:"销售排行榜Top10",component:"rankingBoard",border:"aYinTechBorderB4"},
        {title:"回款变动推送",component:"scrollBoardTable",border:"aYinTechBorderB4"},
        {title:"回款与开票统计",component:"echartsLine1",border:"aYinTechBorderB1"},
        {title:"净利润环比",component:"echartsBar2",border:"aYinTechBorderB1"},
        {title:"合同类型占比",component:"echartsPie1",border:"aYinTechBorderB4"},
      ]
    };
  },
  computed: {},
