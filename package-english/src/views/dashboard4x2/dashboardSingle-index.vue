  ...
  mounted() {
    ...
    if(tipState){
      $timer("notify1",()=>{
        $notify({
          title: 'Prompt',
          message: 'This function is the single-dashboard mode of the 4x2 combination dashboard. For the content developed for the large-dashboard enterprise, it can be displayed on a common PC in a split single-dashboard manner to improve user experience! You can navigate between each data dashboard through the bottom navigation jump.',
          duration: 0
        });
      },5000)
    }
