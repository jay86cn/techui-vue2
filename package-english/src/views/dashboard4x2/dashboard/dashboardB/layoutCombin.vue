<template>
  <div class="dashboardB dashboardSub" id="dashboardB">
...
export default {
  ...
  data() {
    return {
      ...
      portlets:[
        {title:"Anomalous Feature",component:"echartsRadar",border:"DVBorderBox2"},
        {title:"Key Monitoring",component:"echartsGaugeTriple",border:"DVBorderBox1",hideTitle:true},//,class:"noAni"
        {title:"Scatter Distribution",component:"echartScatter",border:"DVBorderBox2"},
        {title:"Production Data",component:"echartsBarB",border:"DVBorderBox2"},
        {title:"Sales Data",component:"echartsLineB",border:"DVBorderBox2"},
      ]
    };
  },
  computed: {},
...
<style lang="less">
.dashboardB {.poa; .fullbox; z-index: 1; padding:30px 30px 56px 30px;//pointer-events: none;
  .grid(24,24,30px);
