<template>
  <div class="dashboardSingleA" id="dashboardA">
    ...
    <mapDrill class="dashboardSingle-map"></mapDrill>
  </div>
</template>
<script>
...
export default {
  ...
  data() {
    return {
      ...
      showMap:false,
      portlets:[
        {title:"Key indicators",component:"counter",border:"aYinTechBorderB1",hideTitle:true},
        {title:"Non-coal mine",component:"echartsPieA",border:"aYinTechBorderB4"},
        {title:"Underground Personnel",component:"personalCondition",border:"aYinTechBorderB4"},
        {title:"Accidents month",component:"echartsLineA",border:"aYinTechBorderB4"},
        {title:"Standardization Coal Mine",component:"pyramid",border:"aYinTechBorderB4"},
        {title:"Internet access",component:"echartsBarSpc",border:"aYinTechBorderB4"},
        {title:"Law Enforcement Situation",component:"echartsBarLineTabs",border:"aYinTechBorderB4",hideTitle:true},
      ]
    };
  },
  computed: {
  ...
  mounted() {
    ...
    this.$timer("showMap",()=>{this.showMap=true},3000)
  },
  destroyed(){
  }
};
...
<style lang="less">
.dashboardSingleA {.poa; .fullbox; z-index: 1; padding:90px 30px; //pointer-events: none;
  .grid(24,24,30px);
  // grid-template-areas:
  // "a a a . . . . . . d d d"
  // "a a a . . . . . . d d d"
