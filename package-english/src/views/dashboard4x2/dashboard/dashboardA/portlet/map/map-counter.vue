...
export default {
  ...
  data() {
    return {
      counterList:[
        {name:"Total Groundwater",icon:"i carbon:carbon-for-ibm-product",num:394,unit:"",plus:1},
        {name:"Water Intake",icon:"i carbon:carbon-ui-builder",num:42558,unit:""},
        {name:"Water Users",icon:"i carbon:carbon-for-ibm-dotcom",num:50262,unit:"",plus:4},
        {name:"Water Intake Location",icon:"i carbon:carbon",num:50262,unit:"",plus:4},
      ]
    };
  },
  computed: {},
...
.dashboard4X2A-map{
  .map-counter-wrap{.poa; left:50%; .fixc("x"); top:100px; z-index: 10;
    .counter-item{.bd(var(--button-bd_hov)); .bgc(var(--popup-bg)); width: 190px; display:inline-block; height: 60px; margin:0 20px 0 0; padding:10px 0 0 60px; position: relative;
