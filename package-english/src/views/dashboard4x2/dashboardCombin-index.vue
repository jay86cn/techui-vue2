  ...
  <div class="dashboard4X2Combin">
    ...
    <template v-else>
      <div class="mobileMode-alert">
        <p class="title">4x2 combination screen tips</p>
        <p>It is detected that you are currently viewing in mobile mode. The 4x2 combined screen has a huge amount of data. Generally, the performance of mobile devices is limited and cannot support the display of this function. </p>
        <p>Please move to PC to visit. </p>
  ...
  data() {
    return {
      ...
      state:{
        ...
        init:0,
        dashboard:[
          {id:0,name: "数据屏A",component:"dashboardA" }, 
          {id:1,name: "数据屏B",component:"dashboardB" }, 
          {id:2,name: "数据屏C",component:"dashboardC" }, 
          {id:3,name: "数据屏D",component:"dashboardD" }, 
          {id:4,name: "数据屏E",component:"dashboardE" }
        ],
      }
    };
  },
    ...
    if(this.deviceType!="mobile"){
      ...
      if(tipState){
        ...
        $timer("notify2",()=>{
          $notify({
            title: 'Prompt',
            message: 'You can change the content of the main dashboard in the middle of the 4x2 splicing dashboard by dragging the panel in the lower right corner. You can customize a large dashboard with any resolution according to the situation.',
            duration: 0
          });
        },5000)
