...
export default {
  ...
  data() {
    return {
      ...
      portlets:[
        {title:"Statistics module",component:"counterGrid",border:"blank",hideTitle:true},
        {title:"Information Board",component:"echartsBarLine1",border:"DVBorderBox1",hideTitle:true},
        {title:"Top 10 sales list",component:"rankingBoard",border:"aYinTechBorderB4"},
        {title:"Payment change push",component:"scrollBoardTable",border:"aYinTechBorderB4"},
        {title:"Receipt and billing",component:"echartsLine1",border:"aYinTechBorderB1"},
        {title:"Net profit chain",component:"echartsBar2",border:"aYinTechBorderB1"},
        {title:"Contract Type",component:"echartsPie1",border:"aYinTechBorderB4"},
      ]
    };
  },
  computed: {},
