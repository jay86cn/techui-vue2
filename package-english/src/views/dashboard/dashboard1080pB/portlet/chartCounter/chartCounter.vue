...
export default {
  ...
  data() {
    return {
      counterList:[
        {name:"Software Sales",num:394,unit:"$10K",barColor:$c.rel3},
        {name:"Hardware Sales",num:42558,unit:"$10K",barColor:$c.yel3},
        {name:"Technical Services",num:50262,unit:"$10K"},
        {name:"Security Service",num:50262,unit:"$10K"},
      ]
    };
  },
  watch:{
