...
.chart-hasTabs-ScreenB{height: 100%;
  .card-header-tabs{position: absolute;  top:0; right:0; padding:0 0; z-index: 10; white-space: nowrap; 
  ...
  .unit{.poa; right:10px;bottom:5px;.fc(var(--font-weak));}
}
