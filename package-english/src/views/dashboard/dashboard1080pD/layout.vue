...
export default {
  ...
  data() {
    return {
      ...
      areas:[
        {name:"left", portlets:[
          {title:"Well Cost",component:"echartsLine1",border:"aYinTechBorderA1",hideTitle:true},
          {title:"Fracking Cost",component:"echartsPie2",border:"aYinTechBorderA1",hideTitle:true},
          {title:"Target Rate",component:"waterLevelPercentPond",border:"aYinTechBorderA1",hideTitle:true},
        ]},
        {name:"right",portlets:[
          {title:"Approval Statistics",component:"echartsBar1",border:"aYinTechBorderA1",hideTitle:true},
          {title:"Well Deviation",component:"scrollBoardTable",border:"aYinTechBorderA1",hideTitle:true},
          {title:"Counter",component:"counterGrid",border:false,hideTitle:true},
        ]},
        {name:"center",portlets:[
          {title:"Statistics module",component:"counterSix",border:"blank",hideTitle:true},
          {title:"Project Audit Statistics",component:"echartsBarHoriz1",border:"aYinTechBorderB1"},
          {title:"Team Commendations",component:"echartPictorialBar",border:"aYinTechBorderB1"},
          {title:"Situation Overview",component:"echartsBarLine1",border:"DVBorderBox5"},
        ]}
      ]
