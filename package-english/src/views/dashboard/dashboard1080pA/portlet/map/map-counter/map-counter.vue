...
export default {
  ...
  data() {
    return {
      counterList:[
        {name:"Software profit",num:394,unit:"Million",barColor:$c.rel3},
        {name:"Hardware profit",num:42558,unit:"Million",barColor:$c.yel3},
        {name:"Technology profit",num:50262,unit:"Million"},
        {name:"Security profit",num:50262,unit:"Million"},
      ]
    };
  },
  watch:{
