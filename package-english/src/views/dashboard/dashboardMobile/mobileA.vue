...
export default {
  ...
  data() {
    return {
      ...
      areas:[
        {name:"top",portlets:[
          {title:"map",component:"mapDrill",border:"aYinTechBorderB4",hideTitle:true},
